...
[dayDirs, sessionList] = ry_selectDays(animalRawDir, 45, 69)
...
recOrder = ry_generateRecOrder(animalRawDir, dayDirs, 'exclusions', [])
...
deepFilenameChange = false; % whether to go beyond simple filename curation (e.g. removal of .2) 
                            % into changing recfiles to their prefixes as specified above!
