% Libaries!
addpath('~/Code/pipeline/preprocess')
...
animal_out_dir = '/Volumes/FastData/Raw/ry_GoalCoding_Project/RY9_experiment/RY9'
%animal_out_dir = '/media/ryoung/Thalamus/ry_GoalCoding_Project/RY9_experiment/RY9'
day_dirs = {'55_20190725',...
            '56_20190727',...
            '57_20190729',...
            '58_20190730',...
            '59_20190731',...
...
RecOrder = {
           ...
           {'RY9_65_01.rec','RY9_65_02.rec','RY9_65_03.rec','RY9_65_04.rec','RY9_65_05.rec'},...
...
for iExport=1:nExport
    for iDay=dayStart:dayStop
        ...
        if iExport == 1
            ...
            [~,old_prefix] = RN_fixFilenames(day_dirs{iDay}, 0);
        end
        ...
        out_dir = fullfile(animal_out_dir, day_dirs{iDay});
